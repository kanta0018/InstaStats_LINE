function reporting(){
  ...
  var SSId = '1jCi7Pt5aPLLZARUl1K7V_9TJKNUM3wSmgpuT8F4UfTo';

  //instagram Graph API 必要情報
  var instragramID = '17841453025470989';
  var username = 'pine_planning';
  var ACCESS_TOKEN = "EABNdWdIMH9UBAFNYV5gUUZCs3Y4cdmgDPlCbOCjqJdPfLoIAZBOIWw7gAKDF6uLTZB3Pdx4AyVwnaZCh6cpCxMi8IRqCQ0vXdTy8wIATSuu6eKlDCHA8uZBVmzCc7mZBYdtIu3nyirOKoha488zT8umlUZBqCzgWZBZARdZAxt4AAhDjMZAyByPX2pI";
...
function getFollower(date,SSId,instragramID,username,ACCESS_TOKEN) {
  ...
  var facebook_url = 'https://graph.facebook.com/v11.0/'+ instragramID +'?fields=business_discovery.username('+ username +'){followers_count,follows_count,media_count}&access_token='+ ACCESS_TOKEN;
